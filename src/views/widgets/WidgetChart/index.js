        ...
        <Col xl={4} md={6}>
          <Card className="pb-0">
            ...
            <Card.Body>
              <AmChartDevices />
              <div className="row">
                <div className="col-sm-12 pt-3 pb-3 border-top d-flex justify-content-between">
                  <span className="me-3">
                    <i className="feather icon-circle text-c-green mx-2" />
                    Desktop
                  </span>
                ...
                <div className="col-sm-12 pt-3 pb-3 border-top d-flex justify-content-between">
                  <span className="me-3">
                    <i className="feather icon-circle text-c-blue mx-2" />
                    Mobile
                  </span>
                  <span className="float-end">32.5 %</span>
                </div>
                <div className="col-sm-12 pt-3 border-top d-flex justify-content-between">
                  <span className="me-3">
                    <i className="feather icon-circle text-c-purple mx-2" />
                    Tablet
                  </span>
          ...
          <Card className="pb-0">
            ...
            <Card.Body>
              ...
              <div className="client-name">
                <div className="row">
                  <div className="col-sm-12 pt-2 pb-2 d-flex justify-content-between">
                    <span className="me-3">
                      <i className="feather icon-circle text-c-green mx-2" />
                      Main wallet
                    </span>
            ...
            <Card.Body>
              ...
              <div className="row">
                <div className="col-sm-12 pt-2 pb-2 d-flex justify-content-between">
                  ...
                  <span className="float-end">15.5 %</span>
                </div>
                <div className="col-sm-12 pt-2 pb-2 d-flex justify-content-between">
                  <span className="me-3">
                    <i className="feather icon-circle text-c-blue mx-2" />
                  ...
                  <span className="float-end">23.5 %</span>
                </div>
                <div className="col-sm-12 pt-2 d-flex justify-content-between">
                  <span className="me-3">
                    <i className="feather icon-circle text-c-purple mx-2" />
                  ...
                  <span className="float-end">36.3 %</span>
                </div>
              </div>
            </Card.Body>
          </Card>
            ...
            <Card.Body>
              ...
              <div className="row">
                <div className="col-sm-12 pt-3 pb-3 mt-3 border-top">
                  ...
                  <span className="float-end">563 / 735</span>
                </div>
                <div className="col-sm-12 pt-3 pb-3 border-top">
                  <span className="me-3">Clicks</span>
                  <span className="float-end">76898 / 95442</span>
                </div>
                <div className="col-sm-12 pt-3 pb-3 border-top">
                  <span className="me-3">Views</span>
                  <span className="float-end">3682 / 4235</span>
                </div>
                <div className="col-sm-12 pt-3 border-top">
                  <span className="me-3">Visits</span>
                  <span className="float-end">2348 / 3749</span>
                </div>
              </div>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="row align-items-center justify-content-center">
                <div className="col">
                  <h3 className="f-w-300 mb-0 float-start">$59,48</h3>
                </div>
