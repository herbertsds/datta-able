                ...
                <div className="col-sm-12 m-b-30">
                  <div className="widget-timeline">
                    <div className="d-flex">
                      <div className="me-3 flex-shrink-0 photo-table">
              ...
              <div className="row">
                <div className="col-sm-12 m-b-30">
                  <div className="widget-todo">
                    <div className="d-flex">
                      <div className="me-3 flex-shrink-0 photo-table">
                        <i className="fa fa-circle text-c-green f-10 me-2" />
                      </div>
                      <div className="flex-grow-1 ms-3">
                ...
                <div className="col-sm-12 m-b-30">
                  <div className="widget-todo">
                    <div className="d-flex">
                      <div className="me-3 flex-shrink-0 photo-table">
                        <i className="fa fa-circle text-c-blue f-10 me-2" />
                      </div>
                      <div className="flex-grow-1 ms-3">
        ...
        <Col md={6} xl={4}>
          <Card className="note-bar">
            ...
            <Card.Body className="p-0">
              <Link to="#" className="d-flex align-items-start friendlist-box">
                <div className="me-3 flex-shrink-0 photo-table">
              ...
              <Link to="#" className="d-flex align-items-start friendlist-box border-top">
                <div className="me-3 flex-shrink-0 photo-table">
                  <i className="fa fa-bell f-30" />
                </div>
                <div style={{ flex: 'auto' }}>
                  <h6>New user register</h6>
                  <span className="f-12 float-end text-muted" style={{ float: 'right' }}>
                    12.36
                  </span>
              ...
              <div className="d-flex align-items-start friendlist-box border-top">
                <div className="me-3 flex-shrink-0 photo-table">
                  <i className="fa fa-bell f-30" />
                </div>
                <div style={{ flex: 'auto' }}>
              ...
              <div className="row">
                <div className="col-sm-12 m-b-20">
                  <div className="widget-lorem">
                    <div className="d-flex media align-items-center justify-content-center receive-bar">
                      <div className="me-3 flex-shrink-0 photo-table">
                ...
                <div className="col-sm-12 m-b-0">
                  <div className="widget-lorem">
                    <div className="d-flex media send-bar">
                      <div className="me-3 flex-shrink-0 photo-table">
