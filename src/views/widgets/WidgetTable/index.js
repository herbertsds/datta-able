...
const WidgetTable = () => {
  const tabContent = (
    <React.Fragment>
      <div className="d-flex media friendlist-box align-items-center justify-content-center m-b-20">
        <div className="m-r-10 flex-shrink-0 photo-table">
          <Link to="#">
      ...
      <div className="d-flex media friendlist-box align-items-center justify-content-center">
        <div className="m-r-10 flex-shrink-0 photo-table">
          <Link to="#">
            <img className="rounded-circle" style={{ width: '40px' }} src={avatar3} alt="activity-user" />
          </Link>
    ...
    <React.Fragment>
      <div className="widget-timeline m-b-25">
        <div className="media d-flex">
          <div className="mr-3 flex-shrink-0 photo-table">
