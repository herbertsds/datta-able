...
const bitcoinData = [
  { name: 'Bitcoin Wallet', amount: '$9,302', details: 'Ratings by Market Capitalization', class: 'theme-bg' },
  { name: 'Bitcoin Wallet', amount: '$8,101', details: 'Ratings by Market Capitalization', class: 'theme-bg2' },
  { name: 'Bitcoin Wallet', amount: '$7,501', details: 'Ratings by Market Capitalization', class: 'bg-c-blue' }
];

const orderData = [
  { amount: '520', heading: 'All Properties', image: shape1, class: 'text-c-green' },
  { amount: '375', heading: 'Sale Product', image: shape2, class: 'text-c-red' },
  { amount: '$874', heading: 'Total Earnings', image: shape3, class: 'text-c-green' }
];

const salesData = [
  { title: 'Miami, Florida', amount: '14,678', heading: 'Today’s Sales', icon: 'fas fa-dollar-sign', color: '#04a9f5' },
  { title: 'Silje Larsen', amount: '15,678', heading: 'Weekly Sales', icon: 'fab fa-bitcoin', color: '#1de9b6' },
  { title: 'Ida Jorgensen', amount: '50,853', heading: 'Monthly Sales', icon: 'fa fa-database', color: '#ff5252' }
];

const propertyData = [
  { amount: '520', heading: 'All Properties', image: shape4, class: 'theme-bg' },
  { amount: '375', heading: 'Sale Product', image: shape5, class: 'theme-bg2' },
  { amount: '$874', heading: 'Total Earnings', image: shape6, class: 'theme-bg' }
];
      ...
      <Row>
            ...
            <Card.Body>
              <div className="row">
                ...
                <div className="col text-end">
                  ...
                  <span className="badge theme-bg m-t-20">1434</span>
                </div>
              </div>
            </Card.Body>
          </Card>
          ...
          <Card className="profit-bar">
            <Card.Body>
              <div className="row">
                ...
                <div className="col">
                  <i className="fa fa-credit-card f-20 text-white float-end" />
                </div>
              </div>
              <h6 className="m-t-20 text-muted">
                <span className="badge theme-bg m-r-10">+11%</span>From Previous Month{' '}
              </h6>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="row align-items-center justify-content-center">
                <div className="col-6">
                  <h2 className="f-w-300 d-flex align-items-center float-start">
                    4.3 <i className="fa fa-star f-12 m-l-10 text-c-yellow" />
                  </h2>
                </div>
                <div className="col-6">
                  <h6 className="f-w-300 d-flex  align-items-center float-end">
            ...
            <Card.Body>
              ...
              <div className="row m-t-25">
                ...
                <div className="col-6 p-l-0">
                  <div className="d-grid">
                    <Link to="#" className="btn text-uppercase border btn-outline-secondary">
                      withdraw
                    </Link>
                  </div>
                </div>
            ...
            <Card.Body>
              ...
              <div className="leads-progress mt-3">
                ...
                <h6 className="text-muted f-w-300 mt-4">
                  Organic Leads <span className="float-end">340</span>
                </h6>
                <h6 className="text-muted f-w-300 mt-4">
          ...
          <Card>
            <Card.Body>
              ...
              <div className="leads-progress mt-3">
                ...
                <h6 className="text-muted f-w-300 mt-4">
                  Total Cost <span className="float-end">340</span>
                </h6>
                <h6 className="text-muted f-w-300 mt-4">
        ...
        <Col md={6} xl={4}>
          <Card className="theme-bg Invoice-bar">
            <Card.Body>
              <div className="invoice-lable text-end">
                <span>
          ...
          <Card className="Online-Order">
            <Card.Body>
              ...
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                Delivery Orders<span className="float-end f-18 text-c-green">237 / 400</span>
              </h6>
              <div className="progress mt-3">
                <div
                  className="progress-bar progress-c-theme"
        ...
        <Col md={6} xl={4}>
          <Card className="Online-Order">
            <Card.Body>
              ...
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                pending Orders<span className="float-end f-18 text-c-purple">100 / 500</span>
              </h6>
              <div className="progress mt-3">
                <div
                  className="progress-bar progress-c-theme2"
        ...
        <Col md={6} xl={4}>
          <Card className="Online-Order">
            <Card.Body>
              <h5>Return Orders</h5>
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                Return Orders<span className="float-end f-18 text-c-blue">50 / 400</span>
              </h6>
              <div className="progress mt-3">
                <div
                  className="progress-bar progress-c-blue"
          ...
          <Card className="affilate-offers">
            <Card.Body>
              ...
              <h2 className="mt-4 mb-0 d-flex align-items-center justify-content-between f-w-300">
                3,789 <label className="label theme-bg text-white f-12 f-w-400 float-end">4+</label>
              </h2>
        ...
        <Col md={6} xl={4}>
          <Card className="affilate-offers">
            <Card.Body>
              ...
              <h2 className="mt-4 mb-0 d-flex align-items-center justify-content-between f-w-300">
                2,586 <label className="label theme-bg text-white f-12 f-w-400 float-end">10+</label>
              </h2>
              <h6 className="d-flex align-items-center justify-content-center mt-3">
          ...
          <Card>
            <Card.Body>
              ...
              <div className="text-center">
                <Link to="#" className="btn btn-primary shadow-2 text-uppercase" style={{ minWidth: '150px' }}>
                  add funds
                </Link>
              </div>
            </Card.Body>
                  ...
                  <div className="row align-items-center justify-content-center">
                    <div className="col">
                      <BarChart width={100} height={80} data={dataSaleView}>
                        <Bar barSize={3} dataKey="a" fill={data.color} />
                      </BarChart>
                    </div>
                    <div className="col-auto text-end">
                      <i className={`${data.icon} f-30 text-white theme-bg`} />
                    </div>
                  </div>
                </Card.Body>
              </Card>
          ...
          <Card className="project-task">
            <Card.Body>
              <div className="row align-items-center justify-content-center">
                ...
                <div className="col-auto">
                  <label className="label theme-bg text-white f-14 f-w-400 float-end">23% Done</label>
                </div>
              </div>
        ...
        {bitcoinData.map((data, index) => {
          return (
            <Col key={index} md={6} xl={4}>
              <Card className={`${data.class} bitcoin-wallet`}>
                <Card.Body>
                  <h5 className="text-white mb-2">{data.name}</h5>
                  <h2 className="text-white mb-3 f-w-300">{data.amount}</h2>
                  <span className="text-white d-block">{data.details}</span>
        ...
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-start summary-box mb-4">
                ...
                <div style={{ flex: 'auto' }}>
                  <i className="card-icon feather icon-download float-end f-34" />
                </div>
              </div>
              <div className="d-flex align-items-start summary-box mb-4">
                <div className="photo-table">
              ...
              <div className="text-center">
                <Link to="#" className="btn btn-primary shadow-2 text-uppercase btn-block" style={{ minWidth: '150px' }}>
                  add friend
                </Link>
              </div>
            </Card.Body>
          ...
          <Card className="statistial-visit">
            ...
            <Card.Body>
              ...
              <div className="d-flex align-items-start mt-4">
                ...
                <div style={{ flex: 'auto' }}>
                  <label className="label theme-bg text-white f-14 f-w-400 float-end">14%</label>
                </div>
              </div>
              <div className="d-flex align-items-start mt-4">
                <div className="photo-table">
                ...
                <div style={{ flex: 'auto' }}>
                  <label className="label theme-bg2 text-white f-14 f-w-400 float-end">14%</label>
                </div>
              </div>
              <div className="d-flex align-items-start mt-4">
                <div className="photo-table">
                ...
                <div style={{ flex: 'auto' }}>
                  <label className="label bg-c-blue text-white f-14 f-w-400 float-end">14%</label>
                </div>
              </div>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="d-flex align-items-start">
                <div className="photo-table">
                  <h6 className="text-muted">
                    Dash/USD<span className="text-c-green ms-3">2.56%</span>
                  </h6>
                  <h6>
                    1,0452 <span className="ms-2"> USD</span>
                  </h6>
                </div>
                <div style={{ flex: 'auto' }}>
                  <span className="float-end">
              ...
              <div className="d-flex align-items-start mt-4">
                <div className="photo-table">
                  <h6 className="text-muted">
                    ETH/USD<span className="text-c-red ms-3">-0.87%</span>
                  </h6>
                  <h6>
                    0,0157<span className="ms-2"> USD</span>
                  </h6>
                </div>
                <div style={{ flex: 'auto' }}>
                  <span className="float-end">
              ...
              <div className="d-flex align-items-start mt-4">
                <div className="photo-table">
                  <h6 className="text-muted">
                    ZEC/USD<span className="text-c-purple ms-3">1.56%</span>
                  </h6>
                  <h6>
                    2,0764<span className="ms-2"> USD</span>
                  </h6>
                </div>
                <div style={{ flex: 'auto' }}>
                  <span className="float-end">
              ...
              <div className="d-flex align-items-start mt-4">
                <div className="photo-table">
                  <h6 className="text-muted">
                    BTC/USD<span className="text-c-green ms-3">2.56%</span>
                  </h6>
                  <h6>
                    1,0452<span className="ms-2"> USD</span>
                  </h6>
            ...
            <Col key={index} md={6} xl={4}>
              <Card>
                <Card.Body>
                  <div className="row align-items-center justify-content-center">
                    <div className="col">
                      <h3 className={data.class}>{data.amount}</h3>
                      <h5>{data.heading}</h5>
                    </div>
                    <div className="col text-end">
                      <img src={data.image} style={{ width: '80px' }} alt="activity-user" />
                    </div>
                  </div>
                </Card.Body>
              </Card>
            ...
            <Col key={index} md={6} xl={4}>
              <Card className={data.class}>
                <Card.Body>
                  <div className="row align-items-center justify-content-center">
                    <div className="col-auto">
                      <img src={data.image} alt="activity-user" />
                    </div>
                    <div className="col">
                      <h2 className="text-white f-w-300">{data.amount}</h2>
