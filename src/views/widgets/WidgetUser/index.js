        ...
        <Col md={6} xl={4}>
          <Card className="theme-bg2 visa-top">
            <Card.Header className="borderless">
              ...
              <img src={visaLogo} className="img-fluid float-end" alt="card title" />
            </Card.Header>
        ...
        <Col md={6} xl={4}>
          <Card className="theme-bg visa-top">
            <Card.Header className="borderless">
              ...
              <img src={masterLogo} className="img-fluid float-end" alt="card title" />
            </Card.Header>
            <Card.Body className="visa">
              <h6 className="f-w-600 text-white ">
        ...
        <Col md={6} xl={4}>
          <Card className="bg-c-blue visa-top">
            <Card.Header className="borderless">
              ...
              <img src={ruPayLogo} className="img-fluid float-end" alt="card title" />
            </Card.Header>
            <Card.Body className="visa">
              <h6 className="f-w-600 text-white ">
