...
const DashCrm = () => {
  const tabContent = (
    <React.Fragment>
      <div className="d-flex align-items-start friendlist-box align-items-center justify-content-center m-b-20">
      ...
      <div className="d-flex align-items-start friendlist-box align-items-center justify-content-center">
        <div className="m-r-10 photo-table">
          <Link to="#">
            <img className="rounded-circle" style={{ width: '40px' }} src={avatar3} alt="activity-user" />
          </Link>
      ...
      <Row>
        ...
        <Col xl={4} md={6}>
          <Card>
            ...
            <Card.Body className="ps-0 pe-0 pb-2">
              ...
              <Card>
                <Card.Body>
                  ...
                  <div className="text-center">
                    <Button variant="primary" className="shadow-2 text-uppercase btn-block" style={{ minWidth: '150px' }}>
                      add funds
                    </Button>
                  </div>
                </Card.Body>
