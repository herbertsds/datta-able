  ...
  return (
    <form onSubmit={handleSubmit(submit)}>
      <Card>
        ...
        <Card.Footer>
          <Button type="button" variant="danger" className="float-end" disabled={pristine || submitting} onClick={reset}>
            Clear Values
          </Button>
          <Button type="submit" className="mr-1 float-end" disabled={submitting}>
            Log In
          </Button>
        </Card.Footer>
      </Card>
