...
const SyncValidationForm = (props) => {
  ...
  return (
    <Card>
      ...
      <Card.Footer>
        <Button variant="danger" className="float-end" type="button" disabled={pristine || submitting} onClick={reset}>
          Clear Values
        </Button>
        <Button type="submit" disabled={submitting} className="mr-1 float-end">
          Submit
        </Button>
      </Card.Footer>
    </Card>
