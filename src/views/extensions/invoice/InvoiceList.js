            ...
            <Col md={6}>
              <Card className="card-border-c-blue">
                <Card.Header>
                  ...
                  <span className="label label-primary float-end"> 28 January, 2015 </span>
                </Card.Header>
            ...
            <Col md={6}>
              <Card className="card-border-c-green">
                <Card.Header>
                  ...
                  <span className="label label-success float-end"> 28 January, 2015 </span>
                </Card.Header>
                <Card.Body className="card-task">
                  <Card.Text className="task-detail">
                    A collection of textile samples lay spread out on the table One morning, when Gregor Samsa woke from troubled.
            ...
            <Col md={6}>
              <Card className="card-border-c-red">
                <Card.Header>
                  ...
                  <span className="label label-danger float-end"> 28 January, 2015 </span>
                </Card.Header>
                <Card.Body className="card-task">
                  <Card.Text className="task-detail">
                    A collection of textile samples lay spread out on the table One morning, when Gregor Samsa woke from troubled.
            ...
            <Col md={6}>
              <Card className="card-border-c-yellow">
                <Card.Header>
                  ...
                  <span className="label label-warning float-end"> 28 January, 2015 </span>
                </Card.Header>
                <Card.Body className="card-task">
                  <Card.Text className="task-detail">
                    A collection of textile samples lay spread out on the table One morning, when Gregor Samsa woke from troubled.
