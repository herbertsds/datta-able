          ...
          <Card>
            ...
            <Card.Body>
              <Row className="justify-content-md-center">
                <Col sm={12} md={7}>
                  <Form.Group className="pb-2" controlId="formPosition">
                ...
                <Col sm={12} md={7}>
                  <Form.Group className="py-2" controlId="formColor">
                ...
                <Col sm={12} md={7}>
                  <Form.Group className="py-2" controlId="exampleForm.ControlTextarea1">
                    <Form.Label>Message</Form.Label>
                    <Form.Control as="textarea" rows="3" value={message} onChange={handleChange} />
                  </Form.Group>
                </Col>
                <Col sm={12} md={7} style={{ marginTop: 16 }}>
                  <Notifications
                    notification={{
                      variant: variant,
                      placement: placement,
