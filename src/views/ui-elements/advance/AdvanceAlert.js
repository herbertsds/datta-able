        ...
        <Col>
          <Card>
            ...
            <Card.Body className="btn-page">
              ...
              <Button
                variant="success"
                onClick={() => sweetAlertHandler({ title: 'Success!', type: 'success', text: 'You clicked the button!', icon: 'success' })}
              >
                Success
              </Button>
              <Button
                variant="danger"
                onClick={() => sweetAlertHandler({ title: 'Error!', type: 'error', text: 'You clicked the button!', icon: 'error' })}
              >
                Error
              </Button>
              <Button
                variant="warning"
                onClick={() => sweetAlertHandler({ title: 'Warning!', type: 'warning', text: 'You clicked the button!', icon: 'warning' })}
              >
                Warning
              </Button>
              <Button
                variant="info"
                onClick={() => sweetAlertHandler({ title: 'Info!', type: 'info', text: 'You clicked the button!', icon: 'info' })}
              >
                Info
              </Button>
